...
> 📚 **Full setup, API-key sourcing, environment variables, multi-account, scheduling, deployment, and troubleshooting:** see **[`docs/DEVELOPER_GUIDE.md`](docs/DEVELOPER_GUIDE.md)**.
